...
href="${pageContext.request.contextPath}/user/orders"><i class="bi bi-receipt me-2"></i> Đơn Mua</a></li>
                                    <c:if test="${sessionScope.currentUser.roleid == 1 ||
sessionScope.currentUser.roleid == 2}">
                                        <li><hr class="dropdown-divider"></li>
                                    ...
                                    <li><hr class="dropdown-divider"></li>
                                    <li><a 
class="dropdown-item" href="${pageContext.request.contextPath}/logout"><i class="bi bi-box-arrow-right me-2"></i> Đăng Xuất</a></li>
                                </ul>
                            </div>
                        </c:otherwise>
        ...
        <div class="container">
            <div class="collapse navbar-collapse">
              ...
              <a class="nav-link fw-bold dropdown-toggle" href="${pageContext.request.contextPath}/products" id="menuDropdown">
                        ...
                        <c:if test="${not empty APP_CATEGORIES}">
...
class="row">
                                   ...
                                   <c:forEach var="cat" items="${APP_CATEGORIES}">
                                                <c:set var="lowerName" value="${fn:toLowerCase(cat.name)}" />
            
                                    <c:if test="${fn:contains(lowerName, 'trà') ||
fn:contains(lowerName, 'cà phê') || fn:contains(lowerName, 'sinh tố') || fn:contains(lowerName, 'nước')}">
                   ...
                   ${cat.name}
                                        ...
                                        <div class="col-lg-4 col-md-6">
                                         ...
                                         <c:forEach var="cat" items="${APP_CATEGORIES}">
                                          ...
                                          <c:if test="${fn:contains(lowerName, 'bánh') ||
fn:contains(lowerName, 'ăn vặt') || fn:contains(lowerName, 'snack')}">
                                                    <a class="dropdown-item" href="${pageContext.request.contextPath}/products?cate=${cat.id}">
