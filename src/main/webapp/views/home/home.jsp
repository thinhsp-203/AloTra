...
<div class="container mb-5">
    ...
    <div class="row row-cols-1 row-cols-md-4 g-4">
        ...
        <c:forEach items="${promotions}" var="promo" varStatus="status" begin="4">
            <div class="col hidden-promotion-item" style="display: none;">
                <div class="card news-card" style="cursor: pointer; transition: transform 0.3s ease;" 
                     onclick="window.location.href='${pageContext.request.contextPath}/promotions?id=${promo.id}'"
                     onmouseover="this.style.transform='translateY(-5px)'"
                     onmouseout="this.style.transform='translateY(0)'">
    ...
    <c:if test="${fn:length(promotions) > 4}">
        <div class="text-center mt-4">
            <button class="btn btn-outline-primary" onclick="showMoreHomepage('promotions', this)">Xem tất cả khuyến mãi</button>
        </div>
    </c:if>
</div>
</c:if>
...
<div class="container mb-5">
    ...
    <div class="row row-cols-1 row-cols-md-2 row-cols-lg-4 g-4">
        ...
        <c:forEach items="${stores}" var="store" begin="4">
            <div class="col hidden-store-item" style="display: none;">
                <div class="card h-100 shadow-sm" style="transition: transform 0.3s ease;" 
                     onmouseover="this.style.transform='translateY(-5px)'"
                     onmouseout="this.style.transform='translateY(0)'">
                    <div class="card-body">
    ...
    <c:if test="${fn:length(stores) > 4}">
        <div class="text-center mt-4">
            <button class="btn btn-outline-primary" onclick="showMoreHomepage('stores', this)">Xem tất cả cửa hàng</button>
        </div>
    </c:if>
</div>
</c:if>
