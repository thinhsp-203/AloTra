...
<div class="row g-4">
        ...
        <div class="card shadow-sm border-0 mb-4">
            <div class="card-header bg-white border-bottom py-3">
                <h6 class="m-0 font-weight-bold text-primary">
                    <i class="fas fa-calendar-day" style="margin-right: 10px;"></i>Doanh thu theo ngày
                </h6>
            </div>
                                    ...
                                    <tr>
                                        <td colspan="2" class="text-center py-5">
                                            <div class="py-4">
                                                ...
                                                <p class="text-muted small mb-0">Chưa có doanh thu trong khoảng thời gian này</p>
                                            </div>
                                        </td>
                                    </tr>
                                </c:when>
    ...
    <div class="col-12">
        <div class="card shadow-sm border-0 mb-4">
            <div class="card-header bg-white border-bottom py-3">
                <h6 class="m-0 font-weight-bold text-primary">
                    <i class="fas fa-calendar-alt" style="margin-right: 10px;"></i>Doanh thu theo tháng
                </h6>
            </div>
            <div class="card-body p-0">
                <div class="table-responsive">
