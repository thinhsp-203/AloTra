...
<div class="row g-4">
    <%-- Top Customers by Revenue Card --%>
    <div class="col-lg-6">
        <div class="card shadow-sm border-0 mb-4">
            <div class="card-header bg-white border-bottom py-3">
                <h6 class="m-0 font-weight-bold text-primary">
                    <i class="fas fa-star" style="margin-right: 10px;"></i>Top khách hàng theo doanh thu
                </h6>
            </div>
                                ...
                                <c:otherwise>
                                    <c:forEach var="tc" items="${topCustomersByRevenue}">
                                        <tr class="border-bottom">
                                            <td class="ps-4">
                                                <div class="fw-semibold">${empty tc[0] ? 'N/A' : tc[0]}</div>
    ...
    <%-- Top Customers by Order Count Card --%>
    <div class="col-lg-6">
        <div class="card shadow-sm border-0 mb-4">
            <div class="card-header bg-white border-bottom py-3">
                <h6 class="m-0 font-weight-bold text-primary">
                    <i class="fas fa-shopping-cart" style="margin-right: 10px;"></i>Top khách hàng theo số đơn hàng
                </h6>
            </div>
            <div class="card-body p-0">
                <div class="table-responsive">
