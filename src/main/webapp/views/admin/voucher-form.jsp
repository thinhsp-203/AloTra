                ...
                <div class="col-md-4">
                    ...
                    <div class="d-flex gap-4">
                        <div class="form-check">
                            ...
                            <label class="form-check-label fw-semibold fs-5" for="discount_type_amount" style="margin-left: 10px; margin-right: 40px;">
                                Giảm số tiền <i class="fas fa-money-bill-wave text-success" style="margin-left: 10px;"></i>
                            </label>
                        </div>
                        <div class="form-check">
                            <input class="form-check-input" type="radio" name="discount_type" 
                            ...
                            <label class="form-check-label fw-semibold fs-5" for="discount_type_percent" style="margin-left: 10px;">
                                Giảm theo <i class="fas fa-percent text-primary" style="margin-left: 10px;"></i>
                            </label>
                        </div>
                    </div>
                </div>
