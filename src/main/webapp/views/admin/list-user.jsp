...
<p class="mb-4">Danh sách và công cụ lọc người dùng trong hệ thống.</p>
...
&& selectedRoleId eq entry.key}">selected</c:if>>${entry.value}</option>
     ...
     <div class="col-md-2 d-flex">
        <button type="submit" class="btn btn-primary flex-grow-1 me-2" title="Lọc">
          <i class="fas fa-filter"></i>
        </button>
        <a class="btn btn-outline-secondary" href="${pageContext.request.contextPath}/admin/users" title="Bỏ lọc"><i class="fas fa-sync-alt"></i></a>
      </div>
    </form>
  </div>
</div>
...
<div class="card shadow mb-4">
  <div class="card-header py-3 d-flex justify-content-between align-items-center">
    <h6 class="m-0 font-weight-bold text-primary">Danh sách người dùng (${totalUsers} tài khoản)</h6>
