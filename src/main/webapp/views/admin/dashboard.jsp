	...
	<div class="col-xl-8 col-lg-7">
		<div class="card shadow mb-4">
			<div
				...
				<h6 class="m-0 font-weight-bold text-primary">Doanh thu 6 tháng
					gần nhất</h6>
			</div>
			<div class="card-body">
	...
	<div class="col-xl-4 col-lg-5">
		<div class="card shadow mb-4">
			<div class="card-header py-3">
				<h6 class="m-0 font-weight-bold text-primary">Top 5 sản phẩm
					bán chạy</h6>
			</div>
						...
						<tbody>
							<c:forEach var="item" items="${stats.topProducts}"
								...
								<tr>
									...
									<td class="text-end"><span class="badge text-bg-success">${item[1]}
											sp</span></td>
								</tr>
							</c:forEach>
						</tbody>
