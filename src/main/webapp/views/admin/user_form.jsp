...
<div class="d-flex justify-content-between align-items-center mb-4">
    <h1 class="h4 mb-0">${empty user ? 'Tạo mới' : 'Chỉnh sửa'} người dùng</h1>
                    ...
                    <div class="row g-3">
                        ...
                        <div class="col-md-6">
                            ...
                            <input type="password" class="form-control" name="password" 
                                   minlength="6" ${empty user ? 'required' : ''}>
                            <c:if test="${not empty user}">
                        ...
                        <div class="col-md-6">
                            ...
                            <select class="form-select" name="roleid" required>
                                ...
                                <option value="3" ${user.roleid == 3 || empty user ? 'selected' : ''}>Khách hàng</option>
                            </select>
                        </div>
                        ...
                        <div class="col-12">
                            <div class="form-check">
                                <input class="form-check-input" type="checkbox" name="isActive" 
                                       id="isActive" ${user.isActive || empty user ? 'checked' : ''}>
