...
public class StoreEditController extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest req, HttpServletResponse resp) 
        ...
        try {
            ...
            Integer storeId = (idParam != null && !idParam.isEmpty()) 
            ...
            stnw.model.Store existingStore = storeService.getStoreById(storeId);
            ...
            req.getSession().setAttribute("success", "Đã cập nhật cửa hàng thành công!");
